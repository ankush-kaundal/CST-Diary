...
<nav class="w3-sidenav w3-collapse w3-black " style="z-index:3;width:300px;border: 1px solid white" id="mySidenav" ><br>
  ...
  <!--<div class="w3-container" >
    <h1><strong>CST Dashboard</strong></h1>
  </div>
  <a href="#" class="w3-padding-16 w3-hide-large w3-dark-grey w3-hover-black" onclick="w3_close()" title="close menu"><i class="fa fa-remove fa-fw"></i>  Close Menu</a>
  <a href="#" class="w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
  <a class="w3-padding"><i class="fa fa-eye fa-fw"></i>  Weekly</a>	
  <a href="#" class="w3-padding"><i class="fa fa-users fa-fw"></i>  Project Details</a>
  <a href="#" class="w3-padding"><i class="fa fa-bullseye fa-fw"></i>  Leave Planner</a>
  <a href="#" class="w3-padding"><i class="fa fa-diamond fa-fw"></i>  CST Checklist</a>
  <a href="#" class="w3-padding"><i class="fa fa-bell fa-fw"></i>  Seat Allocation Link</a>
  <a href="#" class="w3-padding"><i class="fa fa-bank fa-fw"></i>  Resource Utilization</a>
  <a href="#" class="w3-padding"><i class="fa fa-history fa-fw"></i>  Minutes of Meeting</a>
  <a href="#" class="w3-padding"><i class="fa fa-cog fa-fw"></i>  Upcoming Events</a><br><br>-->
  
  <div>
	<!-- <h1 align="center"><strong>CST Dashboard</strong></h1> -->
	
	<form action="overview" method="post" commandName="loginPage">
		<input type="submit" value="Overview" style="color:red;"></br>
	</form>
	
	<form action="weekly" method="post" commandName="weeklyPage">
		<input type="submit" value="Weekly"></br>
	</form>	
