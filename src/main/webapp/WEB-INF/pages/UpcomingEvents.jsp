...
<!-- Sidenav/menu -->
<nav class="w3-sidenav w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;border: 1px solid white" id="mySidenav" ><br>
  ...
  <div>
	...
	<form action="upcomingEvents" method="post" commandName="upcomingEventsPage">	
		<input type="submit" value="Upcoming Events" style="color:red;"></br>
	</form>
  </div>  
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;border: 1px solid white">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Upcoming Events</b></h5>
  </header>
